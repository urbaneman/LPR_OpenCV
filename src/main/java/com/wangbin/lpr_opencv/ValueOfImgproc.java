...
public final class ValueOfImgproc {
    ...
    public static final int resizeImg_width = 540, resizeImg_height = 1080;
    ...
    public static final double contour_minAngle = -30, contour_maxAngle = 30;

    public static final double contour_minSizeRatio_small = 3.14, contour_maxSizeRatio_samll = 10.0,
